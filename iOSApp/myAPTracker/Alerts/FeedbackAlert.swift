...
class FeedbackAlert: UIViewController {
    ...
    public func setCallback(_ callBack: @escaping ()->()) {
    ...
    public static func present(text: String, icon: UIImage, completion: @escaping ()->() = {}) {
        ...
        if var topController = keyWindow?.rootViewController {
            ...
            alert.setText(title: text)
            alert.setIcon(icon: icon)
            alert.setCallback(completion)
